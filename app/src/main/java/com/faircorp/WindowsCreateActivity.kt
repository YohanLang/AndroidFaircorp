                ...
                if (spinner != null) {
                    ...
                    spinner.onItemSelectedListener = object :
                        ...
                        override fun onItemSelected(
                            ...
                            findViewById<TextView>(R.id.edit_window_room_id).text =
                ...
                if (spinner2 != null) {
                    ...
                    spinner2.onItemSelectedListener = object :
                        ...
                        override fun onItemSelected(
                            ...
                            findViewById<TextView>(R.id.edit_window_status).text =
    ...
    fun create(view: View) {
        ...
        when (windowStatus) {
            "OPEN" -> {
                ...
                lifecycleScope.launch(context = Dispatchers.IO) { // (1)
                    runCatching {
                        ApiServices().windowsApiService.create(windowDto).execute()
                    } // (2)
                        .onSuccess {
                            withContext(context = Dispatchers.Main) { // (3)
                                Toast.makeText(
